 ...
 */
class EditPost extends AbstractDto implements PostDTOInterface
{
    /**
     * @Form\AllowEmpty()
     ...
     *     "target_class":"Uthando\Blog\Entity\PostEntity", "fields":"seo", "exclude_field":"seo", "context_field":"old_seo"
     *     }})
     * @Form\Type("Text")
